...
export function OutStoryCenter() {
	return (
				...
				<div className="row align-items-center justify-content-between">
					...
					<div className="col-12 col-md-6 col-lg-5 order-md-1">
						...
						<p className="font-size-lg text-muted">
							Behold divided hath without. Place dominion. Place behold spirit abundantly, void creepeth
							Divided were god herb, it they're beginning itself can't can't created great air his called
							land make fly seasons dry likeness.
						</p>
						<p className="mb-0 font-size-lg text-muted">
							Fish upon you you'll midst waters. Divided had life years to own gathering replenish seasons
							Great meat. Cattle earth were signs winged so image together also.
						</p>
					</div>
				</div>
			</div>
